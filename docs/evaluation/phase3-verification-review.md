...
- pytest with coverage: 485 passed at 93% total coverage; after adding the Docker-context and review-fix regressions, the final suite passed 499 tests, with only the pre-existing Starlette/httpx deprecation warning;
