...
- pytest with coverage: 485 passed at 93% total coverage; after the final hardening regressions, the fresh repository suite passed 531 tests, with only the pre-existing Starlette/httpx deprecation warning;
